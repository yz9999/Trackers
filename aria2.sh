...
crontab_update_start() {
    ...
    echo -e "\n0 7 * * * /bin/bash <(wget -qO- https://raw.githubusercontent.com/yz9999/Trackers/refs/heads/main/tracker.sh) ${aria2_conf} RPC 2>&1 | tee ${aria2_conf_dir}/tracker.log" >>"/tmp/crontab.bak"
